...
class StockLocation(models.Model):
    ...
    def get_search_domain(self, domain):
        ...
        if domain_responsibles and self._context.get('from_action_location_form', False):
    ...
    def read_group(self, domain, fields, groupby, offset=0, limit=None, orderby=False, lazy=True):
        ...
        return super(StockLocation, self).read_group(domain, fields, groupby, offset=offset, limit=limit,
    ...
    def _search(self, domain, offset=0, limit=None, order=None):
        if not self.env.su:
            domain = self.get_search_domain(domain)
        return super(StockLocation, self)._search(domain, offset=offset, limit=limit, order=order)
